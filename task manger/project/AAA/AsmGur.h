...
// 	// their properties.
// 	static char      *regname[3][9];
// 	static char      *segname[8];
// 	static char      *sizename[11];
// 	static t_addrdec addr16[8];
// 	static t_addrdec addr32[8];
// 	static char      *fpuname[9];
// 	static char      *mmxname[9];
// 	static char      *crname[9];
// 	static char      *drname[9];
// 	static char      *condition[16];
